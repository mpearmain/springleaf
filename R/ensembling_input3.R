...
param <- list(objective   = "binary:logistic",
              ...
              "eta" = 0.005,
              "min_child_weight" = 8,
              "subsample" = .6, "colsample_bytree" = .4,
...
fname <- paste("./submissions/predFull3_data",stringr::str_replace(vname, "_",""),"_seed",xseed,"_", todate,".csv", sep = "")
...
fname <- paste("./submissions/predValid3_data",stringr::str_replace(vname, "_",""),"_seed",xseed,"_",todate,".csv", sep = "")
write_csv(submission, fname)