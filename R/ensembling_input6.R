...
fname <- paste("./submissions/predFull6_data",stringr::str_replace(vname, "_",""),"_seed",xseed,"_", todate,".csv", sep = "")
...
fname <- paste("./submissions/predValid6_data",stringr::str_replace(vname, "_",""),"_seed",xseed,"_",todate,".csv", sep = "")
write_csv(submission, fname)