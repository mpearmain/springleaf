...
if __name__ == "__main__":
    ...
    for train, valid in kfolds:
        ...
        model.fit(X_train, Y_train, nb_epoch=10, batch_size=16, validation_data=(X_valid, Y_valid), verbose=1)
